        ...
        <div className="max-w-6xl mx-auto px-6 py-10 space-y-10 text-slate-200">
            <header>
                ...
                <p className="text-slate-300">
                    Practise by topic, sit full past examinations, and receive
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="glass p-6 space-y-4">
                    ...
                    <p className="text-sm text-slate-300">
                        Learn and strengthen individual skills with instant
                        feedback, guided hints, and similar practice questions.
                    </p>
                    ...
                    <Link href="/practice/math-methods/topic" className="inline-block mt-4 px-4 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg font-semibold">
                ...
                <div className="glass p-6 space-y-4">
                    ...
                    <p className="text-sm text-slate-300">
                        Practise real VCAA Examination 1 questions under exam
                        conditions, with exact answers required.
                    </p>
                    <ul className="text-sm list-disc ml-5 text-slate-400 space-y-1">
                ...
                <div className="glass p-6 space-y-4">
                    ...
                    <p className="text-sm text-slate-300">
                        Prepare for Examination 2 with CAS-based extended
                        response questions.
                    </p>
                    <ul className="text-sm list-disc ml-5 text-slate-400 space-y-1">
                        <li>CAS allowed</li>
                    ...
                    <a
                        href="/practice/math-methods/exam-2"
