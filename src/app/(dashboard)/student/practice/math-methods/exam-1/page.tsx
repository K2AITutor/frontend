    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            try {
                ...
                if (!cancelled) {
                    setError(e?.message || `No loaded dataset found for ${selectedExam.year} Exam 1.`);
                }
            } finally {
                ...
                <div className="mt-5">
                    {loading ? (
                        ...
                        <p className="text-sm text-slate-300">
                            No seeded questions found for this exam yet. Build, validate, and seed the dataset first.
                        </p>
                    ) : (
